...
(function() {
  (function($) {
    return window.adoratio = function(c, baseURL) {
      return function(data) {
        var HTMLcontainer, dj, g, getImgCenter, getImgPosition, getImgTiles, map, po, startZoom, svg;
        ...
        dj.drag = function() {
          var container, drag, dragging, map, mousedown, mousemove, mouseup;
        ...
        map = po.map().container(g).add(po.dblclick()).add(dj.drag()).add(po.wheel());
